...
IntColourModel = api.model(
    "IntColourModel",
    {
        "intcolour": IntColourField(
            required=True,
...
SceneModel = SceneModelClass(
    "Scene",
    {
        "foreground colour": IntColourField(
            required=True,
            description="Int colour",
            example=16777215,
            min=0,
        ...
        "background colour": IntColourField(
            required=True,
            description="Int colour",
            example=16777215,
            min=0,
...
class SceneResource(Resource):
    ...
    def get(self, int_id):
        ...
        return {
            "foreground colour": SCENE_DATA_DICT[int_id][0],
    ...
    def put(self, int_id):
        ...
        log.debug("Got parameter: %r", int_id)
        log.debug("Got body: %r", request.data)
        SCENE_DATA_DICT[int_id] = (
            request.json["foreground colour"],
